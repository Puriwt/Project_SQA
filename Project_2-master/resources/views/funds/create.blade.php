...
<div class="container">
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 id="createfund-title" class="card-title">เพิ่มทุนวิจัย</h4>
                ...
                <form class="forms-sample" action="{{ route('funds.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input id="fund_name" type="text" name="fund_name" class="form-control" placeholder="name">
                        </div>
                    </div>
                    
                    <div class="form-group row">
                        <label id="support_resource" for="exampleInputsupport_resource" class="col-sm-2 ">หน่วยงานที่สนับสนุน / โครงการวิจัย </label>
                        <div class="col-sm-8">
                    ...
                    <a id="cancel-btn" class="btn btn-light" href="{{ route('funds.index')}}">Cancel</a>
                </form>
            </div>
        </div>
    </div>
